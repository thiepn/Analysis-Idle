...
Publication is a chapter-level state transformation triggered only by the chapter capstone and required core projects. Offline simulation stops when it becomes available.

## Natural Numbers transform
