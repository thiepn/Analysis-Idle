...
## Selected primary stocks

| Resource | Type/unit | Producer | Exclusive sinks | Cap/decay | Offline/reset/later role | Removal test |
|---|---|---|---|---|---|---|
| Precision | chapter-local stock, `precision` | Formalize activity | formal obligations, definitions, reusable lemmas | milestone cap; no decay | safe-policy production; resets Publication; later formal methods | Removing it eliminates formal-vs-discovery preparation |
| Intuition | chapter-local stock, `intuition` | Explore activity | examples, counterexamples, requirement/alternate reveals | milestone cap; no decay | same; resets Publication; later experimental methods | Removing it makes all projects known formal work |
...
## Flow, persistence, and reset

```text
Attention → Formalize → Precision ┐
