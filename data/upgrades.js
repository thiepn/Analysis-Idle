export const UPGRADE_DEFINITIONS = {
  ...
  mathematicalInduction: concept(
    ...
    "Prove the base case. Prove the inductive step. Conclude for all n ∈ ℕ.",
  ...
  additiveInverses: concept(
    ...
    "For every a ∈ ℤ, there is an element -a such that a + (-a) = 0.",
    chapter("integers"),
  ...
  divisibility: concept(
    ...
    "a divides b if there exists k ∈ ℤ such that b = ak.",
    researched("additiveInverses"),
    buildingMultiplier("examples", 1.2),
  ),
  primeNumbers: concept(
    ...
    synergyMultiplier("definitions", "examples", 0.04),
  ),
  euclideanAlgorithm: concept(
    ...
    buildingMultiplier("exercises", 1.2),
  ),
  ...
  fractionDefinition: concept(
    ...
    "A rational number is represented by a/b with a ∈ ℤ and b ≠ 0.",
  ...
  suprema: concept(
    ...
    buildingMultiplier("examples", 1.35),
  ),
  infima: concept(
    "Infima",
    "realNumbers",
    ...
    researched("suprema"),
    buildingMultiplier("exercises", 1.35),
  ),
  completenessAxiom: concept(
    ...
    "Every nonempty set bounded above has a supremum in ℝ.",
    researched("infima"),
    globalMultiplier(1.35),
  ),
  archimedeanProperty: concept(
    ...
    "For every real x, some n ∈ ℕ satisfies n > x.",
  ...
  cantorTheorem: concept(
    ...
    "The real numbers cannot be placed in one-to-one correspondence with ℕ.",
