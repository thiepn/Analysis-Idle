...
Simulate to unresolved decisions, then apply an explicit safe policy within bounded credit windows.
...
12h/72h/25% windows are configurable hypotheses, not validated retention targets. This evidence narrows implementation choices; it does not measure fun.
