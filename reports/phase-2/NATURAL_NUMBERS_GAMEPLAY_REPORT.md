...
The chapter starts with one zero-cost convention confirmation, then reveals passive study, Intuition, Attention allocation, projects, approaches, Technique artifacts, upgrades, automation, Insight, the Proof Map, capstone assembly, and Publication only when each system becomes relevant. The final deterministic state records 12 completed projects and one Publication.
